package com.ttd.framework.container;

import com.ttd.framework.annotation.MyScope;
import com.ttd.framework.context.BeanDefinition;
    ...
    public boolean registerBean(String beanName, Class<?> clazz) {
        return Optional.ofNullable(clazz)
                .map(c -> {
                    ...
                    BeanScope scope = Optional.ofNullable(c.getAnnotation(MyScope.class))
                            .map(MyScope::value)
